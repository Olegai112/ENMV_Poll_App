...
class MainWindow():
    def __init__(self):
        ...
        self.frame_calibrator = tk.Frame(self.root, bg="red")
        self.calibrator = CalibView(self.frame_calibrator)

        self.frame_precision_research = tk.Frame(self.root, bg="blue")
        self.precision_research = PrecisionResearch(self.frame_precision_research, self.connection, self.calibrator)
        ...
        self.frame_precision_research.place(relx=1/3, relheight=1/3, relwidth=1/3)
